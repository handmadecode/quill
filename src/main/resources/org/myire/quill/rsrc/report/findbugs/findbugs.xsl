 ...
 *                   BugInstance elements instead of looking at the
 *                   FindBugsSummary/@total_classes attribute, which sometimes
 *                   is 0 although there are BugInstance elements.
 *
 *******************************************************************************
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="BugCollection">
    ...
    <div class="mainsection">
      ...
      <!-- Report header -->
      <div class="mainheader">FindBugs Report</div>
  ...
  <!-- Output a table with some overall statistics of the FindBugs run -->
  <xsl:template name="output-statistics-table">
    ...
    <table class="mainsectionitem" width="30%" cellpadding="2" cellspacing="0" border="0">
      ...
      <tr>
        <td class="label">FindBugs version:</td>
